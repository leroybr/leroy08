...
const Hero: React.FC<HeroProps> = ({ onSearch, onQuickLinkClick, isSearching }) => {
  ...
  const slides = [
    ...
    {
      image: 'https://images.unsplash.com/photo-1444723121867-7a241cacace9?q=80&w=1920&auto=format&fit=crop', // High quality aerial city/lake view
      title: 'Bienvenidos',
      subtitle: 'Propiedades exclusivas'
    }
  ];
    ...
    <section className="relative h-screen w-full overflow-hidden bg-leroy-black">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-8 text-center text-white">
        <div className="mb-6 overflow-hidden">
          <span className="inline-block text-[10px] font-bold uppercase tracking-[0.4em] animate-slideUp text-white/90 drop-shadow-sm">
        ...
        <div className="overflow-hidden mb-8">
          <h1 
            ...
            className="text-4xl md:text-6xl lg:text-6xl font-serif font-medium leading-[1.1] tracking-tight animate-slideInRight drop-shadow-[0_4px_20px_rgba(0,0,0,0.25)]"
          >
            {slides[activeSlide].title}
          </h1>
          <p 
            key={`subtitle-${activeSlide}`}
            className="text-xl md:text-2xl font-serif italic mt-6 opacity-0 animate-fadeIn delay-500 drop-shadow-[0_2px_10px_rgba(0,0,0,0.2)]"
          >
