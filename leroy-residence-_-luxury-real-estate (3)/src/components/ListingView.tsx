    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-8 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-medium text-white mb-6 animate-slideInRight leading-[1.1] drop-shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
            {currentHero.title}
          </h1>
          <p className="text-[10px] md:text-xs font-bold uppercase tracking-[0.5em] text-leroy-orange animate-fadeIn opacity-90">
