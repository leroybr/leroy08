...
const PropertyDetailView: React.FC<PropertyDetailViewProps> = ({ property, onGoHome }) => {
  ...
  return (
    <div className="pt-32 pb-20 bg-white min-h-screen">
      ...
      {/* Main Gallery Grid */}
      <div className="max-w-7xl mx-auto px-8 mb-12 grid grid-cols-1 md:grid-cols-4 gap-1.5 h-[400px]">
      ...
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2">
            ...
            <div className="mb-10">
              ...
              <h1 className="font-serif text-4xl text-leroy-black mb-4 leading-tight">{property.title}</h1>
              
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-leroy-black font-medium mb-4">
              ...
              <div className="flex items-center text-sm font-medium text-[#008489] mb-6">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                {property.location}
              </div>

              <div className="flex items-center gap-6 text-[11px] text-gray-400 font-medium border-t border-gray-100 pt-6">
            ...
            <div className="border-t border-gray-100 pt-12 mb-16 relative">
            ...
            <div className="mb-16">
              <h3 className="font-serif text-2xl mb-6">Descripción</h3>
              <p className="text-gray-600 text-base leading-relaxed mb-6 whitespace-pre-wrap">{property.description}</p>
            </div>
            
            <div className="mb-16">
              <h3 className="font-serif text-2xl mb-6">Comodidades</h3>
          ...
          <aside className="relative">
            <div className="sticky top-32 bg-white p-8 border border-gray-100 shadow-sm">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <p className="font-bold text-lg text-leroy-black uppercase tracking-tight">Janice Le Roy</p>
                ...
                <form className="space-y-4">
                  <input type="text" placeholder="Tu nombre" className="w-full border border-gray-200 p-3 text-sm focus:border-[#008489] outline-none transition-colors" />
                  <input type="email" placeholder="Tu dirección de correo electrónico" className="w-full border border-gray-200 p-3 text-sm focus:border-[#008489] outline-none transition-colors" />
                  
                  <div className="flex">
                    <div className="w-20 border border-gray-200 border-r-0 p-3 text-sm flex items-center justify-between cursor-pointer">
                      <span>+56</span>
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                    </div>
                    <input type="tel" placeholder="Número de teléfono (opcional)" className="flex-grow border border-gray-200 p-3 text-sm focus:border-[#008489] outline-none transition-colors" />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea 
                      rows={4} 
                      className="w-full border border-gray-200 p-3 text-sm focus:border-[#008489] outline-none transition-colors resize-none"
