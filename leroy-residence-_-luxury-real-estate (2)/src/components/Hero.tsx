      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-8 text-center text-white">
        ...
        <div className="w-full max-w-4xl animate-slideUp delay-300">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <button 
              onClick={() => onQuickLinkClick('Propiedades en Venta')}
              className="px-8 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-white hover:text-leroy-black transition-all"
            >
              Propiedades en Venta
            </button>
            <button 
              onClick={() => onQuickLinkClick('Propiedades en Arriendo')}
              className="px-8 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-white hover:text-leroy-black transition-all"
            >
